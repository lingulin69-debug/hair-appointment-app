        ...
        <div className="space-y-6">
          <div>
            ...
            <select
              ...
              className="w-full cursor-pointer rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-4 text-lg font-bold text-[#4A3B32] outline-none"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-4 text-xl font-black text-[#4A3B32] outline-none focus:border-[#4A3B32]"
              placeholder="請輸入項目名稱"
            />
          </div>
          ...
          {itemData.type === 'service' && (
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-4 text-lg font-bold text-[#4A3B32] outline-none focus:border-[#4A3B32]"
              />
            </div>
          )}
        </div>
