        ...
        <div className="custom-scrollbar flex-1 space-y-8 overflow-y-auto pr-1">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-xl font-bold leading-relaxed text-[#4A3B32] shadow-inner outline-none transition-colors focus:border-[#4A3B32] focus:bg-white"
