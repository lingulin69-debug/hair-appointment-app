      ...
      >
        <div className="mb-8 flex shrink-0 items-center justify-between border-b border-[#E2DCD0] pb-6">
          ...
          <button
            ...
            aria-label={isEditMode ? '關閉編輯預約視窗' : '關閉新增預約視窗'}
          >
        ...
        <div className="custom-scrollbar flex-1 space-y-8 overflow-y-auto pr-2">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-2xl font-black text-[#4A3B32] shadow-inner outline-none transition-colors focus:border-[#4A3B32] focus:bg-white"
                placeholder="請輸入顧客姓名"
                autoFocus
              />
              {typingMatchedClient && (
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-xl font-bold text-[#4A3B32] shadow-inner outline-none transition-colors focus:border-[#4A3B32] focus:bg-white"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className="w-full cursor-pointer rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-xl font-black text-[#4A3B32] shadow-inner outline-none"
              >
            ...
            <div>
              ...
              <select
                ...
                className="w-full cursor-pointer rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-xl font-black text-[#4A3B32] shadow-inner outline-none disabled:cursor-not-allowed disabled:opacity-60"
              >
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#E2DCD0] bg-[#FCFAF5] px-5 py-5 text-xl font-black text-[#4A3B32] shadow-inner outline-none transition-colors focus:border-[#4A3B32] focus:bg-white"
              />
            </div>
